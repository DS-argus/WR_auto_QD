...
from idxdata.historical_data import get_hist_data_from_sql, get_hist_data
...
if __name__ == "__main__":
    ...
    start_date = "2000-01-04"  # 시작일 문자열로 받기
    ...
    MP_barrier = 0.6
    df = get_hist_data_from_sql(start_date, date.today(), underlying, type='w')
    df2 = get_hist_data()
    #ELS 생성
